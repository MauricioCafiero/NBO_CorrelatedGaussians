...
C                FAIRFAX, VA 22030
C
C+++++++++++MODIFIED BY DON KINGHORN 5/22/95++++++++++++++++++
C     ADDED STEPHEN NASH'S (BLAS VARIANT)  DXPY ROUTINE TO THE 
C     END OF THIS FILE SO THAT LOCAL BLAS CAN BE LINKED TO CODE
C     RATHER THAN THE BLAS INCLUDED BY NASH
C
C     ADDED MCHPR1 VALUES FOR 486 PC, DEC ALPHA
C
C     1/2/96 ADDED CODE TO WRITE A PUNCH FILE AFTER EACH MAJOR ITERATION
C     TO BE USED FOR RESTATRING JOBS
c
c     Fri Aug 28 10:40:15 MST 1998  : line 332
c     added a flush call to dump the buffer so that 
c     TNRESTRT.PT actually gets written! (and std out!)
C
C******************************************************************
...
C     CODE ADDED BY D B KINGHORN 1/2/96 FOR CREATING A PUNCH FILE 
C     FOR RESTARTS AFTER A MAJOR ITERATION
      OPEN( UNIT=10, FILE='TNRESTRT.PT', STATUS='UNKNOWN' )
      DO I=1,N
            WRITE(10,*) X(I)
      END DO
...
c$$$      open(unit=663, file="oldquit.dat.new", status="unknown",  
c$$$     +     action="write", position="rewind", iostat=iii)
c$$$      if(iii .ne. 0)then
c$$$      call biout('could not open oldquit.dat.new')
c$$$      else
c$$$      wRITE(6,*)'WRITING THE restart file'
c$$$      wRITE(7,*)'WRITING THE restart file'
c$$$      end if
c$$$      write(663,*)symcode
c$$$      write(663,*)'r'
c$$$      write(663,*)M
c$$$      do i=1,m
c$$$         write(663,*)'t', aa1(i), aa2(i)
c$$$      end do
c$$$      write(663,*)''
c$$$      do i=1,m
c$$$         write(663,*)'t', b12(i), c(i)
c$$$      end do
c$$$      write(663,*)''
c$$$      do i=1,m
c$$$          write(663,*)'t', ry1(i), rx1(i)
c$$$      end do
c$$$      write(663,*)''
c$$$      do i=1,m
c$$$           write(663,*)'t', ry2(i), rx2(i)
c$$$      end do
c$$$      close(663)
c$$$      call flush(663)
c$$$      call flush(6)
